...
import (
	...
	extHello "github.com/pvsnp9/grpc-example/pkg/protogen/hello"
...
func request_HelloService_SayHelloContinous_0(ctx context.Context, marshaler runtime.Marshaler, client extHello.HelloServiceClient, req *http.Request, pathParams map[string]string) (extHello.HelloService_SayHelloContinousClient, runtime.ServerMetadata, error) {
	var metadata runtime.ServerMetadata
	stream, err := client.SayHelloContinous(ctx)
	if err != nil {
		grpclog.Infof("Failed to start streaming: %v", err)
		return nil, metadata, err
	}
...
func RegisterHelloServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extHello.HelloServiceServer) error {
	...
	mux.Handle("POST", pattern_HelloService_SayHelloContinous_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		err := status.Error(codes.Unimplemented, "streaming calls are not yet supported in the in-process transport")
		_, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		return
...
func RegisterHelloServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extHello.HelloServiceClient) error {
	...
	mux.Handle("POST", pattern_HelloService_SayHelloContinous_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/hello.HelloService/SayHelloContinous", runtime.WithHTTPPathPattern("/hello.HelloService/SayHelloContinous"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_HelloService_SayHelloContinous_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_HelloService_SayHelloContinous_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_HelloService_SayHelloContinous_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"hello.HelloService", "SayHelloContinous"}, ""))
)
...
var (
	...
	forward_HelloService_SayHelloContinous_0 = runtime.ForwardResponseStream
)
